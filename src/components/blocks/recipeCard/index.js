...
const RecipeCard = () => {
    return (
        <div className={`mb-6 lg:mb-8 cursor-pointer ${style.card}`}>
            <div className="h-[17rem] bg-grayColor rounded-2xl object-contain flex justify-center">
                <img src={RecipeImg} alt="Recipe" className="h-[17rem] object-contain p-2" />

                <button type='button' className='absolute top-4 right-4 bg-[#4C4A4B] px-3 py-3 rounded-xl flex justify-center items-center'>
            ...
            <div className="pt-4 px-3">
                <p className="font-semibold text-textColor   text-lg lg:text-xl">Miso Soup</p>
                <p className="mt-1 text-sm-15 text-gray-500 leading-6">
                    Loren ipsum ipsoen sonjfhsjhbabshvgjhdbfmascj gdshjvhbcjabcahjdgcahbcjbhbajchbj
                </p>
            </div>
        </div>
    )
